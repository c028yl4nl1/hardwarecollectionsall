...
impl Device {
    pub fn new() -> Device {
        ...
        let processes: Vec<String> = sys
            ...
            .collect();
        let ram: String = convert_bytes(sys.total_memory() as f64);
        ...
        let disk: Vec<String> = sys
            ...
            .map(|disk| {
                format!(
                    ...
                    convert_bytes(disk.total_space() as f64)
                )
            })
            .collect();
...
fn convert_bytes<T: Into<f64>>(size: T) -> String {
    let size = size.into();
